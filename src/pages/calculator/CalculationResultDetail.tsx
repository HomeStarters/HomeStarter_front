        ...
        <CardContent>
          ...
          >
            <Typography variant="caption" color="text.secondary">
              ※ DSR은 대출자산의 대출실행 금액 및 상환기간 기준으로 계산됩니다.<br/>
              ※ DSR은 대출유형(주담대/전세/신용/기타) 및 상환유형(원리금균등/원금균등/만기일시/체증식)별로 계산방식을 다르게 적용하여 계산합니다.<br/>
               (기타대출은 신용대출 방식, 전세대출은 이자만 적용, 만기일시/체증식은 원리금균등 방식 등)<br/>
              ※ DTI/DSR의 소득은 프로필 수정 화면에서 입력된 원천징수소득 기준으로 계산됩니다.
            </Typography>
          </Box>
